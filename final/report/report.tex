...
\end{equation}
%TODO: Good explanation why we couldn't use the i2c, dont know exactly why we
%%couldn't do the same had for the i2c
So to solve this problem we had to make a wire with 2 serial resistances of 300
and 200 K $\Omega$. This makes sure only 0.1 mA gets to the Sun Spot and the
other 2V gets grounded through the other side. Like you can see in figure.
