        ...
        NOLIST
;-------------------------------------------------------------------------
; MPLAB-Cxx  PIC18F67K90 processor definition module
; 
...
LCDDATA0            
LCDDATA0bits        RES 1     ; 0xF66
LCDDATA1            
LCDDATA1bits        RES 1     ; 0xF67
LCDDATA2            
LCDDATA2bits        RES 1     ; 0xF68
LCDDATA3            
LCDDATA3bits        RES 1     ; 0xF69
LCDDATA4            
LCDDATA4bits        RES 1     ; 0xF6A
                    RES 1
LCDDATA6            
...
SFR_BANKED0         UDATA H'EF4'

LCDCON              
LCDCONbits          RES 1     ; 0xEF4
LCDPS               
LCDPSbits           RES 1     ; 0xEF5
LCDSE0              
LCDSE0bits          RES 1     ; 0xEF6
LCDSE1              
LCDSE1bits          RES 1     ; 0xEF7
LCDSE2              
LCDSE2bits          RES 1     ; 0xEF8
LCDSE3              
LCDSE3bits          RES 1     ; 0xEF9
LCDSE4              
LCDSE4bits          RES 1     ; 0xEFA

SFR_BANKED1         UDATA H'EFC'
LCDRL               
LCDRLbits           RES 1     ; 0xEFC
LCDREF              
LCDREFbits          RES 1     ; 0xEFD
SSP2CON2            
SSP2CON2bits        RES 1     ; 0xEFE
SSP2CON1            
SSP2CON1bits        RES 1     ; 0xEFF

SFR_BANKED2         UDATA H'F00'
SSP2STAT            
SSP2STATbits        RES 1     ; 0xF00
SSP2ADD             
SSP2ADDbits         RES 1     ; 0xF01
SSP2BUF             RES 1     ; 0xF02
T4CON               
T4CONbits           RES 1     ; 0xF03
PR4                 RES 1     ; 0xF04
TMR4                RES 1     ; 0xF05
CCP7CON             
CCP7CONbits         RES 1     ; 0xF06
CCPR7               
CCPR7L              RES 1     ; 0xF07
CCPR7H              RES 1     ; 0xF08
CCP6CON             
CCP6CONbits         RES 1     ; 0xF09
CCPR6               
CCPR6L              RES 1     ; 0xF0A
CCPR6H              RES 1     ; 0xF0B
CCP5CON             
CCP5CONbits         RES 1     ; 0xF0C
CCPR5               
CCPR5L              RES 1     ; 0xF0D
CCPR5H              RES 1     ; 0xF0E
CCP4CON             
CCP4CONbits         RES 1     ; 0xF0F
CCPR4               
CCPR4L              RES 1     ; 0xF10
CCPR4H              RES 1     ; 0xF11
T5GCON              
T5GCONbits          RES 1     ; 0xF12
T5CON               
T5CONbits           RES 1     ; 0xF13
TMR5L               RES 1     ; 0xF14
TMR5H               RES 1     ; 0xF15
PMD3                
...
T12CON              
T12CONbits          RES 1     ; 0xF30
PR12                RES 1     ; 0xF31
TMR12               RES 1     ; 0xF32
T10CON              
T10CONbits          RES 1     ; 0xF33
PR10                RES 1     ; 0xF34
TMR10               RES 1     ; 0xF35
T8CON               
...
TMR6                RES 1     ; 0xF3B
T7GCON              
T7GCONbits          RES 1     ; 0xF3C
T7CON               
T7CONbits           RES 1     ; 0xF3D
TMR7L               
TMR7Lbits           RES 1     ; 0xF3E
TMR7H               RES 1     ; 0xF3F
CCP10CON            
...
; unimplemented addresses.
    ...
    CODE
__zero_memory
    movlw  0xF4      ;low byte of (end address + 1)
    movwf  PRODL, 0
