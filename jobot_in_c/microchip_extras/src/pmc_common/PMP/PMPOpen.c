...
/******************************************************************************
  Function:        void PMPOpen(UINT control, UINT mode, UINT port, UINT addrs, BYTE interrupt)
...
void PMPOpen(UINT control, UINT mode, UINT port, UINT addrs, BYTE interrupt)
{
    ...
    IPR1bits.PMPIP = interrupt & 0x01;     // mask just the pmp priority bits  
    PIE1bits.PMPIE = (interrupt & 0x02)>>1;         // mask just the pmp interrupt enable bit
