...
loop_l
    ...
    bra    loop_l
        ...
        GLOBAL RXB1D7bits
        GLOBAL RXB1D7
        GLOBAL CANSTATRO0bits
        GLOBAL CANSTATRO0
        GLOBAL CANSTAT_R01bits
        GLOBAL CANSTAT_R01
