; $Id: mchrpgm.asm,v 1.4 2008/06/27 23:33:48 curtiss Exp $
...
jNoMatch
  ; Load 3 byte NULL to stack at FSR0
          ...
          movlw     -2
          clrf      PLUSW1,ACCESS
          ; Copy the three NULL Bytes to __AARGB2:__AARGB1:__AARGB0 before retuning to the caller.
          Stk3CpyToReg -4,__AARGB2
          return
