...
/**
 * ToneGenerator generates a tone from a simple scale.
 * This is used to drive the small speaker on the JPB board.
 * Later on we plan to implement a real frequence generator
 * where the frequency may be given as an input.
 */
