 ...
 *  Ver 2.0 - 01-07-2006 Soccer version with speech demo (32%)
 */
...
public class UVMDemo extends UVMRunnable implements AgentWebService, TimerListener
{
	 ...
	 * In addition to the DIP setting, the current state may be altered dynamically
	 * by the various behaviors .
	 */
	...
	/**
	 * [WebService] reportState overrides the currentDIP value which allows the
	...
	public void run()
	{
		System.out.println("JPB2SoccerDemo V2.0");
