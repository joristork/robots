...
/**
 *  Class for a simple key-value pair in which the value is an int.
 *  The key (iherited) must be a string. 
 */
public class RecordEntryInt extends RecordEntry {
    ...
    public void copyValueInto(RecordEntry re) {
        ((RecordEntryInt) re).setValue(value);
    }
}
