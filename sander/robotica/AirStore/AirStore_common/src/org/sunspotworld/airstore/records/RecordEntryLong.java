...
/**
 *  Class for a simple key-value pair in which the value is a long.
 *  The key (iherited) must be a string. 
 */
public class RecordEntryLong extends RecordEntry {
    ...
    public void copyValueInto(RecordEntry re) {
        ((RecordEntryLong) re).setValue(value);
    }
}
