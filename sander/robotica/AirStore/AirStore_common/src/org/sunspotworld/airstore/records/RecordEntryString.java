...
/**
 *  Class for a simple key-value pair in which the value is a String.
 *  The key (iherited) must be a string. 
 */
public class RecordEntryString extends RecordEntry {
    ...
    public void copyValueInto(RecordEntry re) {
        ((RecordEntryString) re).setValue(value);
    }
