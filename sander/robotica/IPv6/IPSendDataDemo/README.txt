Sun SPOT IP Send Data Demo - Version 1.0

Based on the Send Data Demo by Ron Goldman.
Modified by Pete St. Pierre
...
2(a)   IPSendDataDemo-onDesktop:
       ...
       be running the IPSendDataDemo-onSPOT portion of the code entirely 
       on emulated SPOTs]. It listens for the sensor sample broadcasts
       and prints them.  

2(b)   IPSendDataDemo-GUIonDesktop:
...
1. Compile and deploy code to Sun SPOTs.
   ...
   (a) Go into the IPSendDataDemo-onSPOT directory, connect a SPOT to 
   ...
   (b) Go into the IPSendDataDemo-onSPOT directory and execute:
       ...
       emulator. 
         ...
         ii.  Right click on the virtual SPOT, choose "Deploy a MIDlet 
              ...
              Navigate to the IPSendDataDemo-onSPOT subdirectory and select
...
2. Run the host application
   ...
   (a) Go into the IPSendDataDemo-onDesktop directory, connect a basestation
       to your host using a USB cable and execute:

       ant host-run

   (b) Go into the IPSendDataDemo-onDesktop directory and execute:
...
3. Repeat step 2 only this time use the IPSendDataDemo-GUIonDesktop
