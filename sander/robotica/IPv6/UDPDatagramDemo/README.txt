Sun SPOT UDP/IP Demo - Version 1.0
...
2(a)   UDPClient-onDesktop:
       ...
       be running the UDPServer-onSPOT portion of the code entirely 
...
1. Compile and deploy code to Sun SPOTs.
   ...
   (a) Go into the UDPServer-onSPOT directory, connect a SPOT to 
   ...
   (b) Go into the UDPServer-onSPOT directory and execute:
       ...
       emulator. 
         ...
         ii.  Right click on the virtual SPOT, choose "Deploy a MIDlet 
              ...
              Navigate to the UDPServer-onSPOT subdirectory and select
...
2. Run the host application
   ...
   (a) The UDPClient-onDesktop program requires 1 argument, the address
       ...
       Go into the UDPClient-onDesktop directory, connect a basestation
   ...
   (b) Go into the UDPClient-onDesktop directory and execute the above command
